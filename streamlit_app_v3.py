...
try:
    ...
    STAIR_PATTERNS = {
        "コの字_時計回り_北スタート": {
            ...
            "description": "1-4段: 左下90cm枠、5-10段: 中央踊り場、11-14段: 右上90cm枠（対称配置）",
            "steps": [
                # 1-4段目: 左下の90cm枠内の矩形（y=0~0.9の範囲）
                # x方向は矩形全体の1/3（pattern全体は2.7m、各枠は0.9m）
                {"name": "stair1", "x": 0, "y": 0, "z": 0.193, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair2", "x": 0, "y": 0.225, "z": 0.386, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair3", "x": 0, "y": 0.45, "z": 0.579, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair4", "x": 0, "y": 0.675, "z": 0.772, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                
                # 5段目: 左側三角形（x=0~0.9の範囲） - 4本の細い矩形で近似
                {"name": "stair5_1", "x": 0, "y": 0.9, "z": 0.965, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair5_2", "x": 0.225, "y": 1.05, "z": 0.965, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair5_3", "x": 0.45, "y": 1.2, "z": 0.965, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair5_4", "x": 0.675, "y": 1.275, "z": 0.965, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 6段目: 中央台形（x=0.9~1.8の範囲） - 4本の細い矩形で近似
                {"name": "stair6_1", "x": 0.9, "y": 0.9, "z": 1.158, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair6_2", "x": 1.125, "y": 1.05, "z": 1.158, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair6_3", "x": 1.35, "y": 1.2, "z": 1.158, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair6_4", "x": 1.575, "y": 1.275, "z": 1.158, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 7段目: 左側三角形（x=0~0.9の範囲） - 4本の細い矩形で近似
                {"name": "stair7_1", "x": 0, "y": 0.9, "z": 1.351, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair7_2", "x": 0.225, "y": 1.05, "z": 1.351, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair7_3", "x": 0.45, "y": 1.2, "z": 1.351, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair7_4", "x": 0.675, "y": 1.275, "z": 1.351, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 8段目: 右側三角形（x=1.8~2.7の範囲） - 4本の細い矩形で近似
                {"name": "stair8_1", "x": 1.8, "y": 0.9, "z": 1.544, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair8_2", "x": 2.025, "y": 1.05, "z": 1.544, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair8_3", "x": 2.25, "y": 1.2, "z": 1.544, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair8_4", "x": 2.475, "y": 1.275, "z": 1.544, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 9段目: 中央台形（x=0.9~1.8の範囲） - 4本の細い矩形で近似
                {"name": "stair9_1", "x": 0.9, "y": 0.9, "z": 1.737, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair9_2", "x": 1.125, "y": 1.05, "z": 1.737, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair9_3", "x": 1.35, "y": 1.2, "z": 1.737, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair9_4", "x": 1.575, "y": 1.275, "z": 1.737, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 10段目: 右側三角形（x=1.8~2.7の範囲） - 4本の細い矩形で近似
                {"name": "stair10_1", "x": 1.8, "y": 0.9, "z": 1.930, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair10_2", "x": 2.025, "y": 1.05, "z": 1.930, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair10_3", "x": 2.25, "y": 1.2, "z": 1.930, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair10_4", "x": 2.475, "y": 1.275, "z": 1.930, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 11-14段目: 右上の90cm枠内の矩形（y=0~0.9の範囲、1-4と対称）
                # x方向は矩形全体の1/3（pattern全体は2.7m、各枠は0.9m）
                {"name": "stair11", "x": 1.35, "y": 0.675, "z": 2.123, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair12", "x": 1.35, "y": 0.45, "z": 2.316, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair13", "x": 1.35, "y": 0.225, "z": 2.509, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair14", "x": 1.35, "y": 0, "z": 2.702, "x_len": 1.35, "y_len": 0.225, "z_len": 0.05},
            ]
        }
    }
