    ...
    STAIR_PATTERNS = {
        "コの字_時計回り_北スタート": {
            ...
            "steps": [
                ...
                {"name": "stair1", "x": 0, "y": 0, "z": 0.193, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair2", "x": 0, "y": 0.225, "z": 0.386, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair3", "x": 0, "y": 0.45, "z": 0.579, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair4", "x": 0, "y": 0.675, "z": 0.772, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                
                # 5段目: 左上の三角形（90cm枠内）- 4本の細い矩形で近似
                ...
                # 6段目: 台形（壁接触90度）- 4本の細い矩形で近似
                {"name": "stair6_1", "x": 0.9, "y": 0.9, "z": 1.158, "x_len": 0.225, "y_len": 0.7, "z_len": 0.05},
                {"name": "stair6_2", "x": 1.125, "y": 1.0, "z": 1.158, "x_len": 0.225, "y_len": 0.5, "z_len": 0.05},
                {"name": "stair6_3", "x": 1.35, "y": 1.1, "z": 1.158, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair6_4", "x": 1.575, "y": 1.15, "z": 1.158, "x_len": 0.225, "y_len": 0.2, "z_len": 0.05},
                
                # 7段目: 左上の三角形（90cm枠内）- 4本の細い矩形で近似
                {"name": "stair7_1", "x": 0.9, "y": 0.9, "z": 1.351, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair7_2", "x": 1.125, "y": 1.05, "z": 1.351, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair7_3", "x": 1.35, "y": 1.2, "z": 1.351, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair7_4", "x": 1.575, "y": 1.275, "z": 1.351, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 8段目: 右上の三角形（90cm枠内）- 4本の細い矩形で近似
                {"name": "stair8_1", "x": 0.9, "y": 0.9, "z": 1.544, "x_len": 0.225, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair8_2", "x": 1.125, "y": 1.05, "z": 1.544, "x_len": 0.225, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair8_3", "x": 1.35, "y": 1.2, "z": 1.544, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair8_4", "x": 1.575, "y": 1.275, "z": 1.544, "x_len": 0.225, "y_len": 0.15, "z_len": 0.05},
                
                # 9段目: 台形（壁接触90度）- 4本の細い矩形で近似
                {"name": "stair9_1", "x": 0.9, "y": 0.9, "z": 1.737, "x_len": 0.225, "y_len": 0.7, "z_len": 0.05},
                {"name": "stair9_2", "x": 1.125, "y": 1.0, "z": 1.737, "x_len": 0.225, "y_len": 0.5, "z_len": 0.05},
                {"name": "stair9_3", "x": 1.35, "y": 1.1, "z": 1.737, "x_len": 0.225, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair9_4", "x": 1.575, "y": 1.15, "z": 1.737, "x_len": 0.225, "y_len": 0.2, "z_len": 0.05},
                
                # 10段目: 右上の三角形（90cm枠内）- 4本の細い矩形で近似
                ...
                {"name": "stair11", "x": 1.8, "y": 0.675, "z": 2.123, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair12", "x": 1.8, "y": 0.45, "z": 2.316, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair13", "x": 1.8, "y": 0.225, "z": 2.509, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
                {"name": "stair14", "x": 1.8, "y": 0, "z": 2.702, "x_len": 0.9, "y_len": 0.225, "z_len": 0.05},
            ]
        }
    }
