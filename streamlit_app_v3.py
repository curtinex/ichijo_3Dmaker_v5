...
try:
    ...
    STAIR_PATTERNS = {
        "コの字_時計回り_北スタート": {
            ...
            "description": "1-4段目: 矩形、5-10段目: 三角形・台形（矩形近似）、11-14段目: 矩形",
            "steps": [
                # 1-4段目: 北向き（Y+方向）- 90cmフレームの矩形
                {"name": "stair1", "x": 0, "y": 0, "z": 0.193, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                {"name": "stair2", "x": 0, "y": 0.25, "z": 0.386, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                {"name": "stair3", "x": 0, "y": 0.5, "z": 0.579, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                {"name": "stair4", "x": 0, "y": 0.75, "z": 0.772, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                
                # 5段目: 左側三角形（Y+方向）- 4本の細い矩形で近似
                {"name": "stair5_1", "x": 0, "y": 1.00, "z": 0.965, "x_len": 0.9, "y_len": 0.0625, "z_len": 0.05},
                {"name": "stair5_2", "x": 0.15, "y": 1.0625, "z": 0.965, "x_len": 0.6, "y_len": 0.0625, "z_len": 0.05},
                {"name": "stair5_3", "x": 0.3, "y": 1.125, "z": 0.965, "x_len": 0.3, "y_len": 0.0625, "z_len": 0.05},
                {"name": "stair5_4", "x": 0.4, "y": 1.1875, "z": 0.965, "x_len": 0.1, "y_len": 0.0625, "z_len": 0.05},
                
                # 6段目: 台形（X+方向）- 4本の細い矩形で近似
                {"name": "stair6_1", "x": 0.25, "y": 0.9, "z": 1.158, "x_len": 0.0625, "y_len": 0.7, "z_len": 0.05},
                {"name": "stair6_2", "x": 0.3125, "y": 1.0, "z": 1.158, "x_len": 0.0625, "y_len": 0.5, "z_len": 0.05},
                {"name": "stair6_3", "x": 0.375, "y": 1.1, "z": 1.158, "x_len": 0.0625, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair6_4", "x": 0.4375, "y": 1.15, "z": 1.158, "x_len": 0.0625, "y_len": 0.2, "z_len": 0.05},
                
                # 7段目: 左側三角形（X+方向）- 4本の細い矩形で近似
                {"name": "stair7_1", "x": 0.5, "y": 0.9, "z": 1.351, "x_len": 0.0625, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair7_2", "x": 0.5625, "y": 1.05, "z": 1.351, "x_len": 0.0625, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair7_3", "x": 0.625, "y": 1.2, "z": 1.351, "x_len": 0.0625, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair7_4", "x": 0.6875, "y": 1.275, "z": 1.351, "x_len": 0.0625, "y_len": 0.15, "z_len": 0.05},
                
                # 8段目: 右側三角形（X+方向）- 4本の細い矩形で近似
                {"name": "stair8_1", "x": 0.75, "y": 1.35, "z": 1.544, "x_len": 0.0625, "y_len": 0.9, "z_len": 0.05},
                {"name": "stair8_2", "x": 0.8125, "y": 1.5, "z": 1.544, "x_len": 0.0625, "y_len": 0.6, "z_len": 0.05},
                {"name": "stair8_3", "x": 0.875, "y": 1.65, "z": 1.544, "x_len": 0.0625, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair8_4", "x": 0.9375, "y": 1.725, "z": 1.544, "x_len": 0.0625, "y_len": 0.15, "z_len": 0.05},
                
                # 9段目: 台形（X+方向）- 4本の細い矩形で近似
                {"name": "stair9_1", "x": 1.0, "y": 1.5, "z": 1.737, "x_len": 0.0625, "y_len": 0.7, "z_len": 0.05},
                {"name": "stair9_2", "x": 1.0625, "y": 1.6, "z": 1.737, "x_len": 0.0625, "y_len": 0.5, "z_len": 0.05},
                {"name": "stair9_3", "x": 1.125, "y": 1.7, "z": 1.737, "x_len": 0.0625, "y_len": 0.3, "z_len": 0.05},
                {"name": "stair9_4", "x": 1.1875, "y": 1.75, "z": 1.737, "x_len": 0.0625, "y_len": 0.2, "z_len": 0.05},
                
                # 10段目: 右側三角形（Y-方向）- 4本の細い矩形で近似
                {"name": "stair10_1", "x": 1.35, "y": 2.0, "z": 1.930, "x_len": 0.9, "y_len": 0.0625, "z_len": 0.05},
                {"name": "stair10_2", "x": 1.5, "y": 1.9375, "z": 1.930, "x_len": 0.6, "y_len": 0.0625, "z_len": 0.05},
                {"name": "stair10_3", "x": 1.65, "y": 1.875, "z": 1.930, "x_len": 0.3, "y_len": 0.0625, "z_len": 0.05},
                {"name": "stair10_4", "x": 1.725, "y": 1.8125, "z": 1.930, "x_len": 0.15, "y_len": 0.0625, "z_len": 0.05},
                
                # 11-14段目: 南向き（Y-方向）- 90cmフレームの矩形
                {"name": "stair11", "x": 1.35, "y": 1.75, "z": 2.123, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                {"name": "stair12", "x": 1.35, "y": 1.5, "z": 2.316, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                {"name": "stair13", "x": 1.35, "y": 1.25, "z": 2.509, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
                {"name": "stair14", "x": 1.35, "y": 1.0, "z": 2.702, "x_len": 0.9, "y_len": 0.25, "z_len": 0.05},
            ]
        }
    }
